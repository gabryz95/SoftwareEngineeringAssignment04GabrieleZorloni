...
public final class ActionController {
	...
	// Method that allows us to check if there is already a user with the same username.
	...
	// Method that allows us to check that the login credentials are correct, 
	// i.e. that they belong to a user in the list of users.
